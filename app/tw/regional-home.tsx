...
export default function RegionalHome({introduction}:{introduction?:ReactNode}){
 ...
 return <PlannerLocale value="TW"><AppShell>
  ...
  <div className="app-content">
   ...
   <section className="home-guide-entry contact-entry"><strong>💌 意見與合作邀約</strong><p>遇到問題或有想法，歡迎告訴我們。</p><a href="mailto:choisj2702@gmail.com?subject=KkiniPlan%20台灣">寄信給我們 ↗</a><small>此瀏覽器的紀錄不會同步到其他裝置。</small></section>
  </div>
