...
export default function RegionalHome({introduction}:{introduction?:ReactNode}){
 ...
 return <PlannerLocale value="TW"><AppShell>
  ...
  <div className="app-content">
   ...
   <section className="home-guide-entry"><strong>食品價格・營養比較</strong><p>最多選 4 件商品，並排比較新台幣價格、販售規格與營養標示。</p><Link href="/tw/products">比較台灣商品 →</Link><Link href="/tw/foods/chicken_breast">雞胸肉比較 →</Link><Link href="/tw/foods/fried_rice">冷凍炒飯比較 →</Link><Link href="/tw/categories/ingredients">生鮮食材 →</Link><Link href="/tw/categories/frozen">冷凍食品 →</Link></section>
