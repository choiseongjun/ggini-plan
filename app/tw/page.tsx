...
export const metadata:Metadata={title,description,twitter:{card:"summary",title,description},alternates:{canonical:siteUrl+'/tw',languages:{'ko-KR':siteUrl,'zh-TW':siteUrl+'/tw','x-default':siteUrl+'/'}},openGraph:{title,description,locale:'zh_TW',url:siteUrl+'/tw',siteName:'GginiPlan',type:'website'}};
