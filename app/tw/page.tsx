...
const title='一人餐點推薦・一週餐費預算規劃 | Kkini Plan 台灣';
const description='一個人吃飯也能先規劃餐費。依新台幣預算、天數與用餐時段推薦台灣販售的餐點，整理一週菜單、購物清單與營養標示，讓租屋族和上班族更方便準備每一餐。';
export const metadata:Metadata={title,description,twitter:{card:"summary",title,description},alternates:{canonical:siteUrl+'/tw',languages:{'ko-KR':siteUrl,'zh-TW':siteUrl+'/tw','x-default':siteUrl+'/'}},openGraph:{title,description,locale:'zh_TW',url:siteUrl+'/tw',siteName:'Kkini Plan',type:'website'}};
