...
function getVideos(id:string):Promise<VideoResponse>{
 ...
 const promise=fetch(`/api/recipe-videos?dish=${encodeURIComponent(id)}`).then(r=>r.json()).catch(()=>({error:'영상을 불러오지 못했어요. 다시 시도해 주세요.'}));
