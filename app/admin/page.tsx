...
export default function AdminPage() {
  ...
  const filterKey=JSON.stringify([marketFilter,query,categoryFilter,foodTypeFilter,photoFilter,nutritionFilter,sortOrder]);
