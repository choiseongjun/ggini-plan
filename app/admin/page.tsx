...
export default function AdminPage() {
  ...
  return <main className="admin-shell">
    ...
    <nav className="admin-collection-tabs" aria-label="상품 관리 메뉴"><Link href="/admin" aria-current="page">상품·영양 관리</Link><Link href="/admin/collect">상품 수집 →</Link><Link href="/admin/deals">핫딜 수집·관리</Link></nav>
