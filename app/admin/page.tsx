...
export default function AdminPage() {
  ...
  return <main className="admin-shell">
    ...
    <header className="admin-header"><div><span className="admin-kicker">KKINIPLAN · CONTENT MANAGER</span><h1>상품·영양 정보 관리</h1><p>판매 상품 링크와 표시된 영양 성분을 원문 출처와 함께 관리합니다.</p></div><div><Link href="/admin/metrics">추천·장보기 이용 흐름 →</Link><br/><Link href="/admin/feedback">서비스 이용 의견 →</Link><br/><Link href="/admin/submissions">제보 관리 →</Link><br/><Link href="/">앱으로 돌아가기 ↗</Link></div></header>
