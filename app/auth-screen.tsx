  ...
  return <div className="auth-stage">
    ...
    <div className="auth-content">
      ...
      <div className="auth-card">
        <button className="google-signin" type="button" onClick={signInWithGoogle} disabled={pending || googlePending}>
        ...
        <p className="google-signin-caption">{admin ? "관리자로 등록된 Google 계정을 선택해 주세요." : "처음이라면 구글 계정으로 바로 시작해요."}</p>
        {error && <p className="auth-error" role="alert">{error}</p>}
        <div className="auth-divider"><span>또는 이메일로 계속하기</span></div>
