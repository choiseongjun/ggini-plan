export const excludedFoods = {
 ...
 wheat:'밀',buckwheat:'메밀',oats:'귀리·오트밀',rice:'쌀·밥',
...
export const excludedFoodGroups: {label:string;keys:ExcludedFood[]}[] = [
 ...
 {label:'곡류',keys:['wheat','buckwheat','oats','rice']},
...
export const excludedFoodAliases:Record<ExcludedFood,string[]> = {
 ...
 wheat:['밀','소맥','파스타'],buckwheat:['메밀'],oats:['귀리','오트밀'],rice:['쌀','밥'],banana:['바나나'],broccoli:['브로콜리'],mushroom:['버섯'],onion:['양파'],garlic:['마늘'],tomato:['토마토'],
};
