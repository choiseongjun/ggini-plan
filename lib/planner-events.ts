...
export const plannerEvents=['visit','generated','swapped','seller','photo_logged','weight_logged','push_enabled','push_opened','push_logged','push_action_logged','snack_logged'] as const;
